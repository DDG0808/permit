/**
 * Mozilla Public License 2.0 模板
 */

import type { LicenseTemplate } from '@/types/license.types'

export const mpl20Template: LicenseTemplate = {
  id: 'mpl-2.0',
...
1.11. "Patent Claims" of a Contributor
    ...
    made, import, or transfer of either its Contribution or its
    Contributor Version.
...
who distributes Covered Software as permitted above, be liable to You for
...
create a new license for such software, you should create and use a
varied version of this License if you rename the license and remove
...
---------------------------------------------------------
  ...
  placeholders: [], // MPL 2.0 doesn't require year/name placeholders in the main license text
